...
export default function SatinalmaIdSearch({
  idSearch,
  setIdSearch,
  idLoading,
  idError,
  ...
  return (
    <section className="mb-4 rounded-md border border-zinc-200 bg-white px-3 py-3 text-sm shadow-sm">
      <div className="mb-2">
        <h2 className="text-[13px] font-extrabold tracking-wide text-zinc-800">
          SIRA NO İLE HIZLI ARAMA
        </h2>
      </div>
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-end">
        <div className="flex-1">
          ...
          <input
            ...
            onKeyDown={handleKeyDown}   // ✅ ENTER ile arama
            inputMode="numeric"
            placeholder="Örn: 24"
        ...
        <div className="flex gap-2">
          <button
            ...
            onClick={onSearch}
            disabled={idLoading}
            className="rounded-md bg-zinc-900 px-3 py-1.5 text-[12px] font-semibold text-white shadow-sm hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-60"
          >
