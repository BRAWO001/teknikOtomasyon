// ===============================
// src/components/SatinAlmaReddedilenItem.jsx
// ===============================
import Link from "next/link";

export default function SatinAlmaReddedilenItem({
  item,
  formatDateTime,
  formatDateOnly,
}) {
  ...
  return (
    <Link
      ...
      className="block border-b border-red-200 px-2 py-2 text-[12px] hover:bg-red-50"
    >
      {/* 1. SATIR */}
      ...
      <div className="mt-1 flex flex-wrap items-center gap-x-4 gap-y-1">
        ...
        {benimOnayKaydim && (
          <span className="rounded-full bg-red-100 px-2 py-[2px] text-[11px] font-medium text-red-800">
